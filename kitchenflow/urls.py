...
urlpatterns = [
    ...
    path(
        "ingredients-types/",
        views.IngredientTypeListView.as_view(),
        name="ingredients-types-list"
    ),
    path(
        "ingredients-type/detail/<int:pk>",
        views.IngredientTypeDetailView.as_view(),
        name="ingredient-type-detail"
    ),
    path(
        "ingredients-type/create/",
        views.IngredientTypeCreateView.as_view(),
        name="ingredient-type-create"
    ),
    path(
        "ingredients-type/update/<int:pk>",

...
ScrollTrigger.matchMedia({
  ...
  "(min-width: 1024px)": function () {
    ...
    const addIngButton = document.querySelector(".update__add__ing__button");
    ...
    const letters = Array.from(addIngButton.querySelectorAll(".anim__button"));

    addIngButton.addEventListener("mouseenter", () => {
      const tl = gsap.timeline();
      tl.to(letters, {
        opacity: 0,
        x: 15,
    ...
    addIngButton.addEventListener("mouseleave", () => {
      const tl = gsap.timeline();
      tl.to(letters, {
        opacity: 1,
        x: 0,
